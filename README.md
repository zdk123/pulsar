...
recommend some other packages for installation as needed (such as `huge`). This branch uses Rcpp and
RcppArmadillo for faster computation of some graph features (e.g. see [Additional criteria](#additional-criteria))
section in this README. However, compiling custom C++ package is more bloated and may difficult to
install (i.e. for certain operating systems). Stick to the master branch of this github if this
applies to you.


```r
library(devtools)
install_github("zdk123/pulsar", ref="RcppArma")
library(pulsar)
```
...
![plot of chunk unnamed-chunk-11](http://i.imgur.com/OukF6by.png)
...
![plot of chunk unnamed-chunk-12](http://i.imgur.com/tIJMt6t.png)
